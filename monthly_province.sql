insert into monthly_province (province_id,case_id,mont,total)
select kode_prov
...
group by kode_prov,(select case_id from case_covid where status_detail='closecontact_discarded'),to_char(tanggal,'mm-YYYY') 
union
select kode_prov
...
from staging_closecontact
group by kode_prov,(select case_id from case_covid where status_detail='closecontact_dikarantina'),to_char(tanggal,'mm-YYYY') 
union
select kode_prov
...
from staging_closecontact
group by kode_prov,(select case_id from case_covid where status_detail='closecontact_meninggal'),to_char(tanggal,'mm-YYYY') 
union	
select kode_prov
...
group by kode_prov,(select case_id from case_covid where status_detail='probable_diisolasi'),to_char(tanggal,'mm-YYYY') 
union
select kode_prov
...
from staging_probable
group by kode_prov,(select case_id from case_covid where status_detail='probable_discarded'),to_char(tanggal,'mm-YYYY') 
union
select kode_prov
...
from staging_probable
group by kode_prov,(select case_id from case_covid where status_detail='probable_meninggal'),to_char(tanggal,'mm-YYYY') 
union
select kode_prov
...
group by kode_prov,(select case_id from case_covid where status_detail='suspect_diisolasi'),to_char(tanggal,'mm-YYYY') 
union
select kode_prov
...
from staging_suspect
group by kode_prov,(select case_id from case_covid where status_detail='suspect_discarded'),to_char(tanggal,'mm-YYYY') 
union
select kode_prov
...
from staging_suspect
group by kode_prov,(select case_id from case_covid where status_detail='suspect_meninggal'),to_char(tanggal,'mm-YYYY')
union
select kode_prov
...
group by kode_prov,(select case_id from case_covid where status_detail='confirmation_sembuh'),to_char(tanggal,'mm-YYYY')
union
select kode_prov
...
from staging_confirmation
group by kode_prov,(select case_id from case_covid where status_detail='confirmation_meninggal'),to_char(tanggal,'mm-YYYY');